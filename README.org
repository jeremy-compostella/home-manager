This project aims to optimize the use of solar produced energy in a residential home. In the implementation described below it optimizes three appliances: an Electric Vehicle charger, a water heater and an HVAC system. The project has focused so far on these three appliances because they add up to approximately 70% of a my home energy usage and they are a form of energy storage.

My home is located in Phoenix, Arizona and my solar system is not equipped with battery system. Even though at this location 296 days per year are either sunny or partly sunny, photovoltaic production is still highly unpredictable and I quickly confirmed that a time based schedule was not going to be enough to meet to the ambitious goal of running 100% of the car and approximately 60 to 70% of my home globally on the solar panels production.

The illustration below shows the energy consumption distribution of my home since I started this project.

[[./doc/images/energy_consumption_distribution.png]]

This diagram does not reflect the result of the latest version of this project because I went through several proof of concepts over time. Nevertheless, it allows to see than on average more than 60% of the electricity used came from the solar panels.
